...
final class DisplayPowerController implements AutomaticBrightnessController.Callbacks {
    ...
    public DisplayPowerController(Context context,
        ...
        if (mUseSoftwareAutoBrightnessConfig) {
            ...
            int[] luxDarkened = resources.getIntArray(
                    com.android.internal.R.array.config_autoBrightnessLevels_darkened);
            ...
            Spline screenAutoBrightnessDarkenedSpline = createAutoBrightnessSpline(luxDarkened, screenBrightness);
            if (screenAutoBrightnessSpline == null || screenAutoBrightnessDarkenedSpline == null) {
                ...
                mAutomaticBrightnessController = new AutomaticBrightnessController(this,
                        handler.getLooper(), sensorManager, screenAutoBrightnessSpline, screenAutoBrightnessDarkenedSpline,
