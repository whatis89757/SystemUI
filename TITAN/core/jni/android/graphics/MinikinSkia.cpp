...
bool MinikinFontSkia::isDroidSansChinese() const
{
  return mTypeface->isDroidSansChineseTypefaceAndOverlayed();
}

bool MinikinFontSkia::isDirty() const
{
  return mTypeface->isDirty(true);
}

uint32_t MinikinFontSkia::getThemeID() const
{
  return mTypeface->getThemeID();
}
