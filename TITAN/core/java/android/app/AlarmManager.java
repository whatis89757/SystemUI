...
public class AlarmManager
{
    ...
    public void setExact(int type, long triggerAtMillis, PendingIntent operation) {
    	if(RTC_WAKEUP == type && DESKCLOCK_PACKAGENAME.equals(operation.getTargetPackage())){
    		setImpl(RTC_POWEROFF_WAKEUP, triggerAtMillis, WINDOW_EXACT, 0, operation, null, null);
    	}else {
