...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
    ...
    public void initForMode(final ActionMode mode) {
        ...
        if (mIgnoreHwActionModeStyle) {
            mActionMenuPresenter = new ActionMenuPresenter(mContext, com.android.internal.R.layout.action_menu_layout,
                          mContext.getResources().getIdentifier(
                 "action_menu_item_layout_emui", "layout", "androidhwext"));
        } else {
            mActionMenuPresenter = new ActionMenuPresenter(mContext);
        }
        /*   DTS2015042301272 zhangxinming/00181848 20150429 end > */
