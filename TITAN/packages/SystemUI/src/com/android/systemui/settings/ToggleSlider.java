...
public class ToggleSlider extends RelativeLayout {
    ...
    public static final int MODE_TOGGLE_NONE = 0;
    public static final int MODE_TOGGLE_CHECKBOX = 1;
    public static final int MODE_TOGGLE_SWITCH = 2;
    private int mMode;
    public void setMode(int mode) {
        mMode = mode;
        if (MODE_TOGGLE_CHECKBOX == mMode) {
            mToggle = (CompoundButton) findViewById(R.id.toggle);
        } else {
            mToggle = (CompoundButton) findViewById(R.id.auto);
        }
        mToggle.setOnCheckedChangeListener(mCheckListener);
