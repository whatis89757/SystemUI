...
class GlobalScreenshot {
    ...
    public GlobalScreenshot(Context context) {
        ...
        mBottomLayout = (LinearLayout) mScreenshotLayout.findViewById(R.id.ll_button_screenshot);
        mShareBtn = (TextView) mScreenshotLayout.findViewById(R.id.shareBtn);
        mEditBtn = (TextView) mScreenshotLayout.findViewById(R.id.editBtn);
        mScreenshotLayout.setFocusable(true);
        mScreenshotLayout.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                // Intercept and ignore all touch events
                Log.d("fangjunran", "mScreenshotLayout touched!!!");
                return false;
            }
        });
        mShareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.v("fangjunran", "mShareBtn clicked!!!");
                Intent chooserIntent = Intent.createChooser(mSaveImageInBackgroundTask.getSharingIntent(), null);
                chooserIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK
                        | Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        mEditBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("fangjunran", "mEditBtn clicked!!!");
                Intent editIntent = new Intent("com.android.camera.action.CROP");
    ...
    private void saveScreenshotInWorkerThread(Runnable finisher) {
        ...
        mSaveImageInBackgroundTask = new SaveImageInBackgroundTask(mContext, data, mNotificationManager,
                SCREENSHOT_NOTIFICATION_ID);
        mSaveInBgTask = mSaveImageInBackgroundTask.execute(data);
    }
    ...
    private void startAnimation(final Runnable finisher, int w, int h, boolean statusBarVisible,
        ...
        mScreenshotLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                mBottomLayout.setLayerType(View.LAYER_TYPE_HARDWARE, null);
                mBottomLayout.buildLayer();
        ...
        if (!statusBarVisible || !navBarVisible) {
            ...
            anim.addUpdateListener(new AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mBottomLayout.setAlpha(1f - scaleInterpolator.getInterpolation(t));
                }
            });
        }
        return anim;
