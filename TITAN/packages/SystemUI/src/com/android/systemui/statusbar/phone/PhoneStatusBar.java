...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mSimCarrierText = (TextView)mStatusBarView.findViewById(R.id.sim_carrier);
        mSimCarrierText.setText("No Uim Card\nNo Sim Card");
        ...
        mBatteryController.addStateChangedCallback(new BatteryStateChangeCallback() {
            ...
            public void onBatteryLevelChanged(int level, boolean pluggedIn, boolean charging) {
                ...
                if (level >= 0 && level <= 4) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim0
                            : R.drawable.stat_sys_battery_0);
                } else if (level > 4 && level <= 15) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim15
                            : R.drawable.stat_sys_battery_15);
                } else if (level > 15 && level <= 35) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim28
                            : R.drawable.stat_sys_battery_28);
                } else if (level > 35 && level <= 49) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim43
                            : R.drawable.stat_sys_battery_43);
                } else if (level > 49 && level <= 60) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim57
                            : R.drawable.stat_sys_battery_57);
                } else if (level > 60 && level <= 75) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim71
                            : R.drawable.stat_sys_battery_71);
                } else if (level > 75 && level <= 90) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim85
                            : R.drawable.stat_sys_battery_85);
                } else if (level > 90 && level <= 100) {
                    mBatteryIconView.setBackgroundResource(pluggedIn ? R.drawable.stat_sys_battery_charge_anim100
        ...
        if (isMSim()) {
            ...
            mMSimNetworkController.setSimCarrierText(mSimCarrierText);
            ...
            mSimCarrierText.setVisibility(View.GONE);
...
//                    updateCarrierLabelVisibility(false);
        ...
        mBatteryIconView = (ImageView) mStatusBarView.findViewById(R.id.hw_battery);
