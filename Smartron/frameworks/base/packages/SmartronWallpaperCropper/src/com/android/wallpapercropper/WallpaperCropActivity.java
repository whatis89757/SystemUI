...
public class WallpaperCropActivity extends Activity {
        ...
        actionBar.getCustomView().setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DialogUtils.executeWallpaperTypeSelection(WallpaperCropActivity.this,
                                mOnDialogCancelListener, new DialogUtils.DialogInterfaceClickListener() {
                                    @Override
                                    public void onWallpaperTypeSelected(int wallpaperType) {
                                        cropImageAndSetWallpaper(imageUri, null, finishActivityWhenDone, wallpaperType);
                                    }
                                });
                    }
                });
    ...
    protected void cropImageAndSetWallpaper(Uri uri, OnBitmapCroppedHandler onBitmapCroppedHandler, final boolean finishActivityWhenDone
        ...
        cropTask.setWallpaperType(wallpaperSet);
    ...
    protected static class BitmapCropTask extends AsyncTask<Void, Void, Boolean> {
        ...
        boolean mNoCrop;
        int mWallpaperType = WallpaperManager.FLAG_SYSTEM;//default
        ...
        public void setWallpaperType(int setType) {
            mWallpaperType = setType;
        }
        ...
        public boolean cropBitmap() {
            ...
            if (mSetWallpaper && mNoCrop) {
                try {
                    InputStream is = regenerateInputStream();
                    if (is != null) {
                        wallpaperManager.setStream(is, null, true, mWallpaperType);
                        Utils.closeSilently(is);
                    }
                } catch (IOException e) {
                ...
                if (crop.compress(cf, DEFAULT_COMPRESS_QUALITY, tmpOut)) {
                    ...
                    if (mSetWallpaper && wallpaperManager != null) {
                        try {
                            ...
                            wallpaperManager.setStream(new ByteArrayInputStream(outByteArray), null, true, mWallpaperType);
