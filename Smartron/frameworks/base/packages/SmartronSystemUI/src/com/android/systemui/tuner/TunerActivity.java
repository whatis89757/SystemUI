...
public class TunerActivity extends SettingsDrawerActivity implements
    ...
    private static final String STATUS_BAR_ACTION = "com.android.settings.action.STATUS_BAR_SETTINGS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    boolean showStatusBar = STATUS_BAR_ACTION.equals(action);
            final PreferenceFragment fragment = showDemoMode ? new DemoModeFragment()
                    : showStatusBar ? new StatusBarFragment() : new TunerFragment();
