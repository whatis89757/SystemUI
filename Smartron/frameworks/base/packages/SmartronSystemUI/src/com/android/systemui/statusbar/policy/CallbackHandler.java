 ...
 */
public class CallbackHandler extends Handler implements EmergencyListener, SignalCallback, SignalCallbackExtended {
    ...
    public void setMobileDataIndicators(final IconState statusIcon, final IconState qsIcon,
            ...
            final int stackedVoiceIcon, final String typeContentDescription, final String description,
            final boolean isWide, final int subId, final int embmsIconId,
                ...
                for (SignalCallback signalCluster : mSignalCallbacks) {
                    if (signalCluster instanceof SignalCallbackExtended) {
                        ((SignalCallbackExtended)signalCluster).setMobileDataIndicators(
                                ...
                                activityOut, dataActivityId, stackedDataIcon,
                                stackedVoiceIcon, typeContentDescription, description,
                                isWide, subId, embmsIconId, isMobileIms, isImsOverWifi, roaming);
                    } else {
