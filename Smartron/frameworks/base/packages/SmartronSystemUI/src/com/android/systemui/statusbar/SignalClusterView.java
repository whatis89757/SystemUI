...
public class SignalClusterView extends LinearLayout implements NetworkControllerImpl.SignalCallback, NetworkControllerImpl.SignalCallbackExtended,
    ...
    View mNoSimsCombo;
    ImageView mVpn, mEthernet, mWifi, mAirplane, mNoSims, mEthernetDark, mWifiDark, mNoSimsDark, mImsOverWifiImageView,
                mMobileImsImageView;
    ImageView mWifiActivityInOut;
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        boolean blockIms = blockList.contains(SLOT_IMS);

        if (blockAirplane != mBlockAirplane || blockMobile != mBlockMobile
                || blockEthernet != mBlockEthernet || blockWifi != mBlockWifi || blockIms != mBlockIms) {
    ...
    protected void onFinishInflate() {
        ...
        mWifiActivityInOut       = findViewById(R.id.wifi_inout);
    ...
    public int getWifiActivityId(boolean activityIn,boolean activityOut){
        if(mActivityEnabled && mWifiVisible){
    ...
    public int getMobileActivityId(boolean activityIn,boolean activityOut){
        if(mActivityEnabled){
            if(activityIn && activityOut){
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
            ...
            int embmsIconId, boolean isMobileIms, boolean isImsOverWifi,
            boolean roaming) {
        PhoneState state = getState(subId);
        if (state == null) {
            return;
        ...
        mImsOverWifi = isImsOverWifi && !mBlockIms;
        mMobileIms = isMobileIms && !mBlockIms;
    ...
    public void onRtlPropertiesChanged(int layoutDirection) {
        ...
        if(mWifiActivityInOut != null){
            mWifiActivityInOut.setImageDrawable(null);
        ...
        for (PhoneState state : mPhoneStates) {
            ...
            if(state.mMobileActivityInOut != null) {
                state.mMobileActivityInOut.setImageDrawable(null);
    ...
    private void apply() {
        ...
        if (mWifiVisible) {
            ...
            if(mWifiActivityId != mLastWifiActivityId) {
                mWifiActivityInOut.setImageResource(mWifiActivityId);
        ...
        if (mMobileIms && !mNoSimsVisible) {
            mMobileImsImageView.setVisibility(View.VISIBLE);
        } else {
            mMobileImsImageView.setVisibility(View.GONE);
        }

        if (mImsOverWifi || mMobileIms) {
            mIconLogger.onIconShown(SLOT_IMS);
        } else {
            mIconLogger.onIconHidden(SLOT_IMS);
        }
    ...
    private void applyIconTint() {
        ...
        applyDarkIntensity(
                ...
                mNoSims, mNoSimsDark);
        setTint(mImsOverWifiImageView, DarkIconDispatcher.getTint(
            mTintArea, mImsOverWifiImageView, mIconTint));
        setTint(mMobileImsImageView, DarkIconDispatcher.getTint(
            mTintArea, mMobileImsImageView, mIconTint));
        applyDarkIntensity(
                DarkIconDispatcher.getDarkIntensity(mTintArea, mWifi, mDarkIntensity),
                mWifi, mWifiDark);
        if (mIconTint != Color.WHITE) {
            setTint(mWifiActivityInOut, DarkIconDispatcher.getTint(
                    mTintArea, mWifiActivityInOut, Color.WHITE));
        } else {
            setTint(mWifiActivityInOut, DarkIconDispatcher.getTint(
                    mTintArea, mWifiActivityInOut, Color.BLACK));
        }
        applyDarkIntensity(
    ...
    private class PhoneState {
        ...
        private int mLastMobileTypeId = -1, mLastMobileActivityId = -1;
        private boolean mIsMobileTypeIconWide;
        private String mMobileDescription, mMobileTypeDescription;

        private ViewGroup mMobileGroup;
        private ImageView mMobile, mMobileDark, mMobileType, mMobileRoaming, mMobileEmbms;
        public boolean mRoaming;
        public ImageView mMobileActivityInOut;

        private int mDataActivityId = 0,mMobileActivityId = 0;
        private int mStackedDataId = 0, mStackedVoiceId = 0, mMobileEmbmsId = 0;
        ...
        public void setViews(ViewGroup root) {
            ...
            mMobileActivityInOut = (ImageView) root.findViewById(R.id.mobile_inout);
        ...
        public boolean apply(boolean isSecondaryIcon) {
            if (mMobileVisible && !mIsAirplaneMode) {
                ...
                if (mLastMobileActivityId != mMobileActivityId) {
                    mMobileActivityInOut.setImageResource(mMobileActivityId);
            ...
            mMobileActivityInOut.setVisibility(mMobileActivityId != 0 ? View.VISIBLE : View.GONE);
        ...
        public void setIconTint(int tint, float darkIntensity, Rect tintArea) {
            ...
            setTint(mMobileRoaming, DarkIconDispatcher.getTint(tintArea, mMobileRoaming,
                    tint));
            if (tint != Color.WHITE) {
                setTint(mMobileActivityInOut, DarkIconDispatcher.getTint(tintArea, mMobileActivityInOut,
                        Color.WHITE));
            } else {
                setTint(mMobileActivityInOut, DarkIconDispatcher.getTint(tintArea, mMobileActivityInOut,
                        Color.BLACK));
