...
public class CellularTile extends QSTileImpl<SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        state.activityIn = cb.noSim && cb.enabled && cb.activityIn; //If No sim Data arrows can be hidden
        state.activityOut = cb.noSim && cb.enabled && cb.activityOut; //If No sim Data arrows can be hidden
