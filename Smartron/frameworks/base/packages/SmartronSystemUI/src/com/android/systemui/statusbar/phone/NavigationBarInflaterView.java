...
public class NavigationBarInflaterView extends FrameLayout
    ...
    protected String getDefaultLayout() {
        boolean reverseLayout = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.SWAP_SOFT_NAVIGATION_KEYS_ENABLED, 0) == 1;
        if (reverseLayout) {
            return mContext.getString(R.string.config_navBarRevLayout);
        } else {
    ...
    protected void onAttachedToWindow() {
        ...
        mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(Settings.Global.SWAP_SOFT_NAVIGATION_KEYS_ENABLED),
                true, mRevereseNavigationKeyListener);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        mContext.getContentResolver().unregisterContentObserver(mRevereseNavigationKeyListener);
    ...
    private final ContentObserver mRevereseNavigationKeyListener = new ContentObserver(new Handler()) {
        @Override
    ...
    private View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        if (LEFT.equals(button)) {
            String s = Dependency.get(TunerService.class).getValue(NAV_BAR_LEFT, AUTO_HIDE);
        ...
        } else if (AUTO_HIDE.equals(button)) {
            v = inflater.inflate(R.layout.auto_hide, parent, false);
