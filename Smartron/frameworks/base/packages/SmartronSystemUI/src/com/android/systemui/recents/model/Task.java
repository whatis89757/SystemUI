...
public class Task {
    ...
    @ViewDebug.ExportedProperty(category="recents")
    public String lockTaskDescription;
    @ViewDebug.ExportedProperty(category="recents")
    ...
    public Task(TaskKey key, int affiliationTaskId, int affiliationColor, Drawable icon,
            ...
            String lockTaskDescription, String appInfoDescription, int colorPrimary,
        ...
        this.lockTaskDescription = lockTaskDescription;
    ...
    public void copyFrom(Task o) {
        ...
        this.lockTaskDescription = o.lockTaskDescription;
