...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private static final String SETTINGS_HEAR_BEAT = "smartron_hear_beat";
    ...
    private void registerListeners() {
        ...
        filter.addAction(ConnectivityManager.ETHERNET_DISCONNECTED);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(ConnectivityManager.CONNECTIVITY_ACTION) ||
                action.equals(ConnectivityManager.INET_CONDITION_ACTION) || action.equals(ConnectivityManager.ETHERNET_DISCONNECTED)) {
            updateConnectivity();
    ...
    private void updateConnectivity() {
        ...
        if (mInetCondition && isHearBeatIntentNeeded()) {
            Intent intent = new Intent("com.smartron.intent.ACTION_INTERNET_CONNECTED");
    ...
    private boolean isHearBeatIntentNeeded() {
       return Settings.Global.getString(mContext.getContentResolver(), SETTINGS_HEAR_BEAT) == null;
    }
