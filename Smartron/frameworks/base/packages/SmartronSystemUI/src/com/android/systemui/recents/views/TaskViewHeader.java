...
public class TaskViewHeader extends FrameLayout
    ...
    public void onTaskViewSizeChanged(int width, int height) {
        ...
        if (mTask != null && mTask.isFreeformTask()) {
            ...
            int lockIconWidth = mLockTaskButton.getMeasuredWidth();
            int moveTaskWidth = mMoveTaskButton != null
                    ? mMoveTaskButton.getMeasuredWidth()
                    : 0;
            showTitle = width >= (appIconWidth + lockIconWidth + moveTaskWidth + titleWidth);
            showMoveIcon = width >= (appIconWidth + lockIconWidth + moveTaskWidth);
            showLockIcon = width >= (appIconWidth + lockIconWidth);
        }
        ...
        mLockTaskButton.setVisibility(showLockIcon ? View.VISIBLE : View.INVISIBLE);
    ...
    public void bindToTask(Task t, boolean touchExplorationEnabled, boolean disabledInSafeMode) {
        ...
        mLockTaskButton.setContentDescription(t.lockTaskDescription);
