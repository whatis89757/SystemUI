...
public class RecentsTaskLoadPlan {
    ...
    void preloadPlan(RecentsTaskLoader loader, int runningTaskId,
        ...
        String lockTaskDescFormat = mContext.getString(
                R.string.accessibility_recents_item_will_be_locked);
        ...
        for (int i = 0; i < taskCount; i++) {
            ...
            String lockTaskDescription = String.format(lockTaskDescFormat, titleDescription);
            ...
            Task task = new Task(taskKey, t.affiliatedTaskId, t.affiliatedTaskColor, icon,
                    thumbnail, title, titleDescription, lockTaskDescription, appInfoDescription,
