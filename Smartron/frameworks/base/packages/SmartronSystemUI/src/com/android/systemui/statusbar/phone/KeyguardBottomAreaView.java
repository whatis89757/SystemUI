...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    public void onClick(View v) {
        if (v == mRightAffordanceView) {
            ...
            //FACE_UNLOCK_SUPPORT start
            Log.d(FaceUnlockUtil.TAG, "KeyguardBottomAreaView onClick");
            if(FaceUnlockUtil.getInstance().startFaceUnlockByRetry(FaceUnlockUtil.FACE_UNLOCK_RETRY_IN_PASSWORD)) {
                return;
            }
            //FACE_UNLOCK_SUPPORT end
