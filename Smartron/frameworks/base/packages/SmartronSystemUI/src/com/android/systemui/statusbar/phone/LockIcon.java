...
public class LockIcon extends KeyguardAffordanceView implements OnUserInfoChangedListener {
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        ...
        if (isShown()) {
            //FACE_UNLOCK_SUPPORT start
            FaceUnlockUtil.getInstance().setLockIconBg(true);
            //FACE_UNLOCK_SUPPORT end
    ...
    public void update(boolean force) {
        ...
        if (state != mLastState || mDeviceInteractive != mLastDeviceInteractive
            ...
            //FACE_UNLOCK_SUPPORT start
            if (FaceUnlockUtil.getInstance().setLockIconBg(false)) {
                isAnim = false;
                trustHidden = true;
    ...
    private int getState() {
        ...
        //FACE_UNLOCK_SUPPORT start
        if (!unlockingAllowed && !FaceUnlockUtil.getInstance().faceUnlockBeginning()) {
            mLastState = STATE_FACE_UNLOCK;
        }
        //FACE_UNLOCK_SUPPORT end
