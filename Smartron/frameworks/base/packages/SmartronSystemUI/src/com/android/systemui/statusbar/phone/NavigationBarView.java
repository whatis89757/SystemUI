...
public class NavigationBarView extends FrameLayout implements PluginListener<NavGesture> {
    ...
    boolean mShowAutoHide;
    boolean mAutoHideVisibility = false;
    ...
    private KeyButtonDrawable mAutoHideIconOn;
    private KeyButtonDrawable mAutoHideIconOff;
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        mButtonDispatchers.put(R.id.auto_hide, new ButtonDispatcher(R.id.auto_hide));
    }
    ...
    public ButtonDispatcher getAutoHideButton() {
        return mButtonDispatchers.get(R.id.auto_hide);
    }
    ...
    private void updateIcons(Context ctx, Configuration oldConfig, Configuration newConfig) {
        ...
        if (oldConfig.densityDpi != newConfig.densityDpi
            ...
            mAutoHideIconOn = getDrawable(ctx, R.drawable.auto_hide_on, R.drawable.auto_hide_on_dark);
            mAutoHideIconOff = getDrawable(ctx, R.drawable.auto_hide_off, R.drawable.auto_hide_off_dark);
    ...
    public void setNavigationIconHints(int hints, boolean force) {
        ...
        setAutoHideButtonVisibility(mAutoHideVisibility);
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        if (disableRecent) setAutoHideButtonVisibility(false);
    }
    ...
    public void setAutoHideButtonVisibility(boolean visible) {
        visible = visible && mShowAutoHide;
        if (mAutoHideVisibility != visible) {
            mAutoHideVisibility = visible;
            getAutoHideButton().setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
        }
    }

    public void setAutoHideButtonState(boolean enabled) {
        getAutoHideButton().setImageDrawable(enabled ? mAutoHideIconOn : mAutoHideIconOff);
        mBarTransitions.reapplyDarkIntensity();
    }

    public void setShowAutoHide(boolean show) {
        mShowAutoHide = show;
    }
