...
/**
     * Broadcast intent action indicating that ETHERNET disconnected.
     *
     * @hide
     */
    public static final String ETHERNET_DISCONNECTED =
        "com.smartron.net.conn.ETHERNET_DISCONNECTED";
