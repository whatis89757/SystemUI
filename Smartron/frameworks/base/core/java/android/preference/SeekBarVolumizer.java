...
public class SeekBarVolumizer implements OnSeekBarChangeListener, Handler.Callback {
    ...
    protected void updateSeekBar() {
        ...
        //Seperating Ring and Notification volume, hence removing dependancy.
    ...
    private void updateChangeOnSeekbar() {
        mSeekBar.setOnSeekBarChangeListener(null);
        updateSeekBar();
        mSeekBar.setOnSeekBarChangeListener(this);
    }
    ...
    private final class H extends Handler {
        ...
        public void postUpdateSlider(int volume, int lastAudibleVolume, boolean mute) {
            ...
            Message msg = obtainMessage(UPDATE_SLIDER, volume, lastAudibleVolume, new Boolean(mute));
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AudioManager.VOLUME_CHANGED_ACTION.equals(action)) {
                ...
                int streamValue = /*intent.getIntExtra(AudioManager.EXTRA_VOLUME_STREAM_VALUE, -1)*/mAudioManager.getStreamVolume(streamType);
                ...
                if (mAffectedByRingerMode) {
                    //Don't update notification volume, if it was not originally muted because of Ring volume (AudioManager.RINGER_MODE_VIBRATE).
                    if (mStreamType == AudioManager.STREAM_NOTIFICATION && !mAudioManager.isStreamMute(mStreamType)
                            && mAudioManager.getStreamVolume(mStreamType) == 0) {
                        return;
                    }
                    updateSlider();
                }
