...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
     ...
     */
    @SdkConstant(SdkConstantType.INTENT_CATEGORY)
    public static final String CATEGORY_APP_SOUNDRECORDER = "android.intent.category.APP_SOUNDRECORDER";
    /**
     * Activities that can be safely invoked from a browser must support this
     * category.  For example, if the user is viewing a web page or an e-mail
     * and clicks on a link in the text, the Intent generated execute that
    ...
    /**
     * An int representing the user RunIn.
     *
     * @hide
     */
    public static final String CATEGORY_APP_RUNIN= "android.intent.category.APP_RUNIN";
    /**
    ...
    /**
     * An int representing the CITTest app to get permission.
     *
     * @hide
     */
    @SdkConstant(SdkConstantType.INTENT_CATEGORY)
    public static final String CATEGORY_APP_CIT_SOUNDRECORDER = "android.intent.category.APP_CIT_SOUNDRECORDER";
