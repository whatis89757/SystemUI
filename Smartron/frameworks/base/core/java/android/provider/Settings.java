...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Persistent store for the Fallback ringtone URI.
         * <p>
         * Used as Fallback ringtone, if actual ringtones were deleted.
         *
         * @hide
         */
        public static final String SMARTRON_RINGTONE = "smartron_ringtone";
         ...
         * you give {@link #DEFAULT_RINGTONE_URI_1} to the media player.  It will resolve
         * to the set default ringtone at the time of playing.
         *
         * @see #DEFAULT_RINGTONE_URI_1
         * @hide
         */
        public static final String RINGTONE_1 = "ringtone_1";
         ...
         * @hide
         */
        public static final Uri DEFAULT_RINGTONE_URI_1 = getUriFor(RINGTONE_1);
        ...
        /** {@hide} */
        public static final String RINGTONE_CACHE_1 = "ringtone_cache_1";
        /** {@hide} */
        public static final Uri RINGTONE_CACHE_URI_1 = getUriFor(RINGTONE_CACHE_1);
    ...
    public static final class Secure extends NameValueTable {
        ...
        /**
         * Whether swiping quick settings panel in lock screen to be
         * enabled. The value is a boolean (1 or 0).
         * @hide
         */
        public static final String LOCK_SCREEN_QS_PANEL_ENABLED = "lock_screen_qs_panel_enabled";

        /**
         * A setting that can be read to enable/disable reading mode.
         *
         * @hide
         */
        public static final String READING_MODE_ENABLED = "reading_mode_enabled";

         /**
         * A setting that can be read to enable {@link READING_MODE_ENABLED} reading mode.
         *
         * @hide
         */
        public static final String FULL_READING_MODE_ENABLED = "full_reading_mode_enabled";

         /**
         * A setting that can be read to enable/disable faceunlock
         *
         * @hide
         */
        public static final String FACE_UNLOCK_SUPPORT = "face_unlock_support";
        ...
        /**
         * This preference enables notification visibility controller icon display on the lockscreen.
         * @hide
         */
        public static final String LOCK_SCREEN_SHOW_HIDE_NOTIFICATIONS_ICON =
                "lock_screen_show_hide_notifications_icon";
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            WIFI_DISCONNECT_DELAY_DURATION,
            LOCK_SCREEN_QS_PANEL_ENABLED,
            READING_MODE_ENABLED,
            FULL_READING_MODE_ENABLED,
            FACE_UNLOCK_SUPPORT
        };
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /**
         * Whether tap fingerprint to wake gesture to be
         * enabled. The value is a boolean (1 or 0).
         * @hide
         */
        public static final String FINGERPRINT_WAKE_GESTURE_ENABLED = "fingerprint_wake_gesture_enabled";

        /**
         * Whether flip to mute calls gesture to be
         * enabled. The value is a boolean (1 or 0).
         * @hide
         */
        public static final String FLIP_TO_MUTE_GESTURE_ENABLED = "flip_to_mute_gesture_enabled";

        /**
         * Whether pick device to dial/answer calls gesture to be
         * enabled. The value is a boolean (1 or 0).
         * @hide
         */
        public static final String PICK_UP_CALL_GESTURE_ENABLED = "pick_up_call_gesture_enabled";

        /** Whether the long press fingerprint gesture to lock the device should be
         * enabled. The value is a boolean (2 or 1 or 0).
         * @hide
         */
        public static final String FINGERPRINT_LOCK_ENABLED = "fingerprint_lock_enabled";

        /**
         * Whether the three finger swipe screenshot gesture to be
         * enabled. The value is a boolean (1 or 0).
         * @hide
         */
        public static final String THREE_FINGER_SCREENSHOT_GESTURE_ENABLED = "three_finger_screenshot_gesture_enabled";

        /**
         * A setting that can be read to set layout of the Soft Navigation bar.
         * The value is a boolean (1 or 0).
         * @hide
         */
         public static final String SWAP_SOFT_NAVIGATION_KEYS_ENABLED = "swap_soft_navigation_keys_enabled";

        /**
         * A setting that can be read to set immersive Navigation bar.
         * The value is a boolean (1 or 0).
         * @hide
         */
         public static final String IMMERSIVE_NAVIGATION_KEYS_ENABLED = "immersive_navigation_keys_enabled";

	/**
         * A setting that can be read to show network speed in statusbar
         * enabled. The value is a boolean (1 or 0).
         *
         * @hide
         */
        public static final String SHOW_STATUS_BAR_NETWORK_SPEED = "show_status_bar_network_speed";

        /**
         * A setting that can be read to show Screen Calibration mode.
         *
         * @hide
         */
        public static final String DISPLAY_SCREEN_CALIBRATION_MODE = "display_screen_calibration_mode";

        /**
         * Low battery led color.
         *
         * @hide
         */
        public static final String LOW_BATTERY_LED_COLOR = "low_battery_led_color";

        /**
         * Medium battery led color.
         *
         * @hide
         */
        public static final String MEDIUM_BATTERY_LED_COLOR = "medium_battery_led_color";

        /**
         * Full battery led color.
         *
         * @hide
         */
        public static final String FULL_BATTERY_LED_COLOR = "full_battery_led_color";
         ...
         * @hide
         */
        public static final String MISSED_CALL_LED_COLOR = "missed_call_led_color";

        /**
         * Vibration intensity for call.
         *
         * @hide
         */
        public static final String VIBRATION_PATTERN_CALL = "vibration_pattern_call";

        /**
         * Vibration intensity for notification.
         *
         * @hide
         */
        ...
        /**
         * Whether Double tap screen gesture should wake the phone.
         *
         * @hide
         */
        public static final String DOUBLE_TAP_SCREEN_TO_WAKE_ENABLED = "double_tap_screen_to_wake_enabled";

        /**
         * Whether Draw device screen with "C" to open Camera/Toggle Flashlight.
         *
         * @hide
         */
        public static final String DRAW_SCREEN_OVERLAY_C = "draw_screen_overlay_c";
