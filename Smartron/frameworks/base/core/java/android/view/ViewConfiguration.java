...
public class ViewConfiguration {
    ...
    /**
     * Defines the delay time in milliseconds to take screenshot.
     */
    private static final int SCREENSHOT_TIMEOUT = 200;
    ...
    private final long mScreenshotTimeout;
    ...
    public ViewConfiguration() {
        ...
        mScreenshotTimeout = SCREENSHOT_TIMEOUT;
    }
    ...
    private ViewConfiguration(Context context) {
        ...
        mScreenshotTimeout = res.getInteger(
                com.android.internal.R.integer.config_screenshotTimeout);
    }
    ...
    /**
     * @hide
     * @return delay to take screenshot with VOL_DOWN+POWER keys.
     */
    public long getScreenshotTimeout() {
        return mScreenshotTimeout;
    }
