...
public final class ShutdownThread extends Thread {
    ...
    private static boolean showRebootOption;
    ...
    public static void reboot(final Context context, String reason, boolean confirm) {
        mReboot = true;
        mRebootSafeMode = false;
        showRebootOption=hasRebootOption(context);
    ...
    /**
     * To check power button menu has reboot option or not.
     */
    private static boolean hasRebootOption(Context context) {
        boolean rebootOption  = false;
