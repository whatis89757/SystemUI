...
public final class NotificationRecord {
    ...
    private long[] calculateVibration() {
        ...
        final long[] defaultVibration = NotificationManagerService.getLongArray(
            ...
            NotificationManagerService.getPatternId(mContext,
                    NotificationManagerService.DEFAULT_NOTIFICATION_VIBRATION_TYPE),
            NotificationManagerService.VIBRATE_PATTERN_MAXLEN,
            NotificationManagerService.getLongArray(mContext.getResources(),
