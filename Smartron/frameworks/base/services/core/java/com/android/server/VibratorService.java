...
public class VibratorService extends IVibratorService.Stub
     ...
     * @hide
    **/
    public boolean isX83 =  (SystemProperties.get("ro.product.device","0")).equals("rimoY") ? true : false;
    ...
    VibratorService(Context context) {
        ...
        /**zhoudeshui modify for X83 vibrate adjust begin:Bug #15079 [RIMO-Y]Haptic feed back from keyboard at system default level is not working**/
        long[] clickEffectTimings = isX83 ?getLongIntArray(context.getResources(),com.android.internal.R.array.config_virtualKeyVibePattern_X83):getLongIntArray(context.getResources(),com.android.internal.R.array.config_virtualKeyVibePattern);
        /**zhoudeshui modify for X83 vibrate adjust end**/
