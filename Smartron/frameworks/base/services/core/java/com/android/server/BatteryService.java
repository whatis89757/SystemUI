...
public final class BatteryService extends SystemService {
    ...
    private int mLowBatteryLedColor;
    private int mMediumBatteryLedColor;
    private int mFullBatteryLedColor;
    ...
    private final class SettingsObserver extends ContentObserver {
        private final Uri LOW_BATTERY_LED_URI
                = Settings.Global.getUriFor(Settings.Global.LOW_BATTERY_LED_COLOR);
        private final Uri MEDIUM_BATTERY_LED_URI
                = Settings.Global.getUriFor(Settings.Global.MEDIUM_BATTERY_LED_COLOR);
        private final Uri FULL_BATTERY_LED_URI
                = Settings.Global.getUriFor(Settings.Global.FULL_BATTERY_LED_COLOR);
        ...
        void observe() {
            ...
            resolver.registerContentObserver(LOW_BATTERY_LED_URI,
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(MEDIUM_BATTERY_LED_URI,
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(FULL_BATTERY_LED_URI,
                    false, this, UserHandle.USER_ALL);
            update(null);
        }
        ...
        public void update(Uri uri) {
            ContentResolver resolver = getContext().getContentResolver();
            if (uri == null || LOW_BATTERY_LED_URI.equals(uri)) {
                mLowBatteryLedColor = Settings.Global.getInt(resolver,
                        Settings.Global.LOW_BATTERY_LED_COLOR, mLed.mBatteryLowARGB);
            }
            if (uri == null || MEDIUM_BATTERY_LED_URI.equals(uri)) {
                mMediumBatteryLedColor = Settings.Global.getInt(resolver,
                        Settings.Global.MEDIUM_BATTERY_LED_COLOR, mLed.mBatteryMediumARGB);
            }
            if (uri == null || FULL_BATTERY_LED_URI.equals(uri)) {
                mFullBatteryLedColor = Settings.Global.getInt(resolver,
                        Settings.Global.FULL_BATTERY_LED_COLOR, mLed.mBatteryFullARGB);
            }

            mLed.clearAndUpdateLights();
        }
    }
    ...
    private final class Led {
        ...
        public void updateLightsLocked() {
            ...
            if (level < mLowBatteryWarningLevel) {
                if (status == BatteryManager.BATTERY_STATUS_CHARGING) {
                    ...
                    mBatteryLight.setColor(/*mBatteryLowARGB*/mLowBatteryLedColor);
                } else {
                    // Flash red when battery is low and not charging
                    mBatteryLight.setFlashing(/*mBatteryLowARGB*/mLowBatteryLedColor, Light.LIGHT_FLASH_TIMED,
                ...
                if (status == BatteryManager.BATTERY_STATUS_FULL || level >= 90) {
                    ...
                    mBatteryLight.setColor(/*mBatteryFullARGB*/mFullBatteryLedColor);
                } else {
                    // Solid orange when charging and halfway full
                    mBatteryLight.setColor(/*mBatteryMediumARGB*/mMediumBatteryLedColor);
                }
            } else {
       ...
       public void clearAndUpdateLights() {
           mBatteryLight.turnOff();
           updateLightsLocked();
       }
    }
