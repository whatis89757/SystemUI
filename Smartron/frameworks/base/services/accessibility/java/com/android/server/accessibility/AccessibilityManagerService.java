...
public class AccessibilityManagerService extends IAccessibilityManager.Stub {
    ...
    private void onUserStateChangedLocked(UserState userState) {
        ...
        updateReadingModeDisplayLocked(userState);
    ...
    private void updateReadingModeDisplayLocked(UserState userState) {
        DisplayAdjustmentUtils.applyReadingModeSetting(mContext, userState.mUserId);
    }
    ...
    private final class AccessibilityContentObserver extends ContentObserver {
        ...
        private final Uri mReadingModeUri = Settings.Secure.getUriFor(
                Settings.Secure.READING_MODE_ENABLED);
        ...
        public void register(ContentResolver contentResolver) {
            ...
            contentResolver.registerContentObserver(
                    mReadingModeUri, false, this, UserHandle.USER_ALL);
        }
        ...
        public void onChange(boolean selfChange, Uri uri) {
            synchronized (mLock) {
                ...
                if (mTouchExplorationEnabledUri.equals(uri)) {
                    ...
                    updateDisplayDaltonizerLocked(userState);
                } else if (mReadingModeUri.equals(uri)) {
                    updateReadingModeDisplayLocked(userState);
