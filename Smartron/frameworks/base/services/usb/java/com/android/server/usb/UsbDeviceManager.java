...
public class UsbDeviceManager {
    ...
    public UsbDeviceManager(Context context, UsbAlsaManager alsaManager,
        ...
        BroadcastReceiver switchUsbReceiver = new BroadcastReceiver() {
            @Override
                public void onReceive(Context context, Intent intent) {
                   // SystemProperties.set("sys.usb.config", "diag,serial_smd,serial_tty,rmnet_ipa,mass_storage,adb");
                    try {
        ...
        mfilter.addAction("hymost.com.SWITCH_USB");
        mContext.registerReceiver(switchUsbReceiver, mfilter);
