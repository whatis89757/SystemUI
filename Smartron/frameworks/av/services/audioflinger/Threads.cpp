        ...
        audio_port_handle_t portId)
{
    ...
    ALOGE("Threards.cpp_createTrack: uid: %d and trackcount is = %d\n", (int)uid, trackCountForUid_l(uid));
...
bool AudioFlinger::PlaybackThread::destroyTrack_l(const sp<Track>& track)
{
    ...
    ALOGE("<API name> Track (%p) is being removed (Treads.cpp: destroyTrack)", track.get());
...
void AudioFlinger::PlaybackThread::removeTrack_l(const sp<Track>& track)
{
   ...
   // ALOGE("<API name> Track (%p) is being removed (Treads.cpp: removeTrack)", track.get());
    ALOGE("<API name> Track (%p), is being removed : uid = %d and trackcount is=%d ", track.get(), track->uid(), trackCountForUid_l(track->uid())); 	
