...
public class FingerprintSettings extends SubSettings {
    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment
        ...
        protected void handleError(int errMsgId, CharSequence msg) {
            /* added by xipeng.gu for bug that no stopauthentication called after delete fingerprint*/
            //mFingerprintCancel = null;
            /*  add end*/
            switch (errMsgId) {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            pref.setTitle(R.string.security_settings_fingerprint_enroll_summary);
        }
        ...
        private void addFingerprintItemPreferences(PreferenceGroup root) {
            ...
            for (int i = 0; i < fingerprintCount; i++) {
                ...
                fpList.add(item.getName().toString());
        ...
        private void showProgressDialog() {
            ...
            if (context != null) {
                ...
                sProgressDialog.setMessage(context.getString(R.string.delete_fingerprint));
                                        ...
                                        if (!TextUtils.equals(newName, name)) {
                                            Log.d(TAG, "rename " + name + " to " + newName);
                                             if (!fpList.contains(newName)) {
                                                ...
                                                if (getActivity() != null) {
                                                    Toast.makeText(getActivity(), R.string.security_setting_rename_fingerprint_exists, Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        }
                                        dialog.dismiss();
