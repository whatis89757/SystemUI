...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private static final String FACEUNLOCK_VERIFY_UNLOCK = "faceunlock_verify_unlock";
        private boolean mVerifyUnlock = false;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState != null) {
                ...
                //FACE_UNLOCK_SUPPORT start
                mVerifyUnlock = savedInstanceState.getBoolean(FACEUNLOCK_VERIFY_UNLOCK);
                //FACE_UNLOCK_SUPPORT end
        ...
        public void onSaveInstanceState(Bundle outState) {
            ...
            //FACE_UNLOCK_SUPPORT start
            outState.putBoolean(FACEUNLOCK_VERIFY_UNLOCK, mVerifyUnlock);
            //FACE_UNLOCK_SUPPORT end
            if (mUserPassword != null) {
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled, boolean chooseLockSkipped) {
            ...
            if (quality == DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED) {
                ...
                //FACE_UNLOCK_SUPPORT start
                if ("1".equals(android.os.SystemProperties.get("ro.faceunlock.support", "0"))) {
                    android.provider.Settings.System.putInt(getContext().getContentResolver(), "faceunlock_reset", 1);
                    android.provider.Settings.System.putInt(getContext().getContentResolver(), "faceunlock_turn_on", 0);
                }
                //FACE_UNLOCK_SUPPORT end
            } else {
                removeAllFingerprintForUserAndFinish(mUserId);
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
            //FACE_UNLOCK_SUPPORT start
            boolean hasFaceUnlock = android.provider.Settings.System.getInt(getContext().getContentResolver(), "faceunlock_turn_on", 0)==1;
            //FACE_UNLOCK_SUPPORT end
            ...
            switch (mLockPatternUtils.getKeyguardStoredPasswordQuality(mUserId)) {
                case DevicePolicyManager.PASSWORD_QUALITY_SOMETHING:
                    //FACE_UNLOCK_SUPPORT start
                    if (hasFaceUnlock && hasFingerprints) {
                        return R.string
                                .unlock_disable_frp_warning_content_pattern_fingerprint_faceunlock;
                    } else if(hasFaceUnlock) {
                        return R.string
                                .unlock_disable_frp_warning_content_pattern_faceunlock;
                    } else 
                    //FACE_UNLOCK_SUPPORT end
                ...
                case DevicePolicyManager.PASSWORD_QUALITY_NUMERIC_COMPLEX:
                    ...
                    if (hasFaceUnlock && hasFingerprints) {
                        return R.string
                                .unlock_disable_frp_warning_content_pin_fingerprint_faceunlock;
                    } else if(hasFaceUnlock) {
                        return R.string
                                .unlock_disable_frp_warning_content_pin_faceunlock;
                    } else 
                    //FACE_UNLOCK_SUPPORT end
                    if (hasFingerprints && isProfile) {
                ...
                case DevicePolicyManager.PASSWORD_QUALITY_MANAGED:
                    ...
                    if (hasFaceUnlock && hasFingerprints) {
                        return R.string
                                .unlock_disable_frp_warning_content_password_fingerprint_faceunlock;
                    } else if(hasFaceUnlock) {
                        return R.string
                                .unlock_disable_frp_warning_content_password_faceunlock;
                    } else 
                    //FACE_UNLOCK_SUPPORT end
                    if (hasFingerprints && isProfile) {
                        return R.string
                ...
                default:
                    ...
                    if (hasFaceUnlock && hasFingerprints) {
                        return R.string
                                .unlock_disable_frp_warning_content_unknown_fingerprint_faceunlock;
                    } else if(hasFaceUnlock) {
                        return R.string
                                .unlock_disable_frp_warning_content_unknown_faceunlock;
                    } else 
                    //FACE_UNLOCK_SUPPORT end
                    if (hasFingerprints && isProfile) {
                        return R.string
