...
public class SoundSettings extends DashboardFragment {
    ...
    private static final String KEY_NOTIFICATION_VIBRATION_PATTERN = "notification_pattern";
    private static final String KEY_CALL_VIBRATION_PATTERN = "call_pattern";
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new CallVibrationPatternPreferenceController(context, KEY_CALL_VIBRATION_PATTERN, lifecycle));
        controllers.add(new NotificationVibrationPatternPreferenceController(context, KEY_NOTIFICATION_VIBRATION_PATTERN));
