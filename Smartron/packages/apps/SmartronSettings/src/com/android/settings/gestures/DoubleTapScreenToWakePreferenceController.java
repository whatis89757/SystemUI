...
public class DoubleTapScreenToWakePreferenceController extends GesturePreferenceController {

    // Fixme : Temporarily video pref added. Needs to be changed.
    private static final String PREF_KEY_VIDEO = "gesture_double_tap_power_video";
    private final String TAG = "DoubleTapScreenWake";
    private static final String GESTURE_FILE = "/sys/class/touchscreen/gesture";
    private final String mDoubleTapToWakeKey;
    private Handler mBackgroundHandler;
    private static final String ON = "7";
    private static final String OFF = "6";

    public DoubleTapScreenToWakePreferenceController(Context context, Lifecycle lifecycle, String key) {
        super(context, lifecycle);
        mDoubleTapToWakeKey = key;
    ...
    // Control value of "/sys/class/touchscreen/gesture" below
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.Global.putInt (mContext.getContentResolver (),
                Settings.Global.DOUBLE_TAP_SCREEN_TO_WAKE_ENABLED, enabled ? 1 : 0);
