...
public class ToggleScreenMagnificationPreferenceFragment extends
    ...
    public void onPause() {
        super.onPause();
        // [Bug-8933][RIMO_SRT_N][MagnificationGesture] Songs pauses and doesn't play initially 3-4 taps , after click on Magnification gesture.
        if (mVideoPreference != null) mVideoPreference.onPrepareForRemoval();
    }
