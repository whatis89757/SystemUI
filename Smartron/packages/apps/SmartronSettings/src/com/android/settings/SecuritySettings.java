...
import com.android.settings.security.LockScreenQuickSettingsPreferenceController;
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    static final String KEY_FACE_UNLOCK = "face_unlock";
    @VisibleForTesting
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (mProfileChallengeUserId != UserHandle.USER_NULL
            ...
            //FACE_UNLOCK_SUPPORT start
            maybeAddFaceUnlockPreference(root, mProfileChallengeUserId);
            //FACE_UNLOCK_SUPPORT end
        ...
        //Add options for FaceUnlock and not in Guest mode
        if(mIsAdmin){
            addPreferencesFromResource(R.xml.security_settings_face_unlock);
        }
        ...
        if (securityCategory != null) {
            ...
            //FACE_UNLOCK_SUPPORT start
            maybeAddFaceUnlockPreference(securityCategory, UserHandle.myUserId());
            //FACE_UNLOCK_SUPPORT end
        ...
        //FACE_UNLOCK_SUPPORT start
        Preference faceUnlockSecurityPreference = findPreference("faceunlock_security_preferences");
        if (faceUnlockSecurityPreference != null) {
            if ("3".equals(android.os.SystemProperties.get("ro.faceunlock.menu", "0"))) {
                if (faceUnlockSecurityPreference.getTitle().equals("Face ID")) {
                    ...
                    for (int i = 0; i < packs.size(); i++) {
                        ...
                        if (p.packageName != null && p.packageName.startsWith("com.elephanttek.faceunlock")) {
                            faceUnlockSecurityPreference.setTitle(p.applicationInfo.loadLabel(getContext().getPackageManager()).toString());
                            break;
                        }
                    }
                }
            } else {
                securityCategory.removePreference(faceUnlockSecurityPreference);
            }
        }
        //FACE_UNLOCK_SUPPORT end
    ...
    //FACE_UNLOCK_SUPPORT start
    private void maybeAddFaceUnlockPreference(PreferenceGroup securityCategory, int userId) {
        if ("2".equals(SystemProperties.get("ro.faceunlock.menu", "0"))) {
            Preference faceunlockPreference = new Preference(getContext());
            faceunlockPreference.setKey("faceunlock_security_preference_under_fingerprint");
            securityCategory.addPreference(faceunlockPreference);
            List<PackageInfo> packs = getPackageManager().getInstalledPackages(0);
            for (int i = 0; i < packs.size(); i++) {
                PackageInfo p = packs.get(i);
                if (p.packageName != null && p.packageName.startsWith("com.elephanttek.faceunlock")) {
                    faceunlockPreference.setTitle(p.applicationInfo.loadLabel(getPackageManager()).toString());
                    break;
                }
            }
        }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        //FACE_UNLOCK_SUPPORT start
        } else if (key != null && key.startsWith("faceunlock_security_preference")) {
            List<PackageInfo> packs = getPackageManager().getInstalledPackages(0);
    ...
    private static class SecuritySearchIndexProvider extends BaseSearchIndexProvider {
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(
            ...
            index.add(getSearchResource(context, R.xml.security_settings_face_unlock));
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            //FACE_UNLOCK_SUPPORT start
            keys.add("faceunlock_security_preferences");
            //FACE_UNLOCK_SUPPORT end
    ...
    public static class SecuritySubSettings extends SettingsPreferenceFragment
        ...
        private static final String SWITCH_PREFERENCE_KEYS[] = { KEY_LOCK_AFTER_TIMEOUT,
                KEY_VISIBLE_PATTERN, KEY_POWER_INSTANTLY_LOCKS, KEY_LOCK_SCREEN_QS };

        private TimeoutListPreference mLockAfter;
        private SwitchPreference mVisiblePattern;
        private SwitchPreference mPowerButtonInstantlyLocks;
        private RestrictedSwitchPreference mLockScreenQs;

        private TrustAgentManager mTrustAgentManager;
        private LockPatternUtils mLockPatternUtils;
        private DevicePolicyManager mDPM;
        private OwnerInfoPreferenceController mOwnerInfoPreferenceController;
        private LockScreenQuickSettingsPreferenceController mLockScreenQuickSettingsPreferenceController;
        ...
        public void onCreate(Bundle icicle) {
            ...
            mLockScreenQuickSettingsPreferenceController = new LockScreenQuickSettingsPreferenceController(getContext());
            createPreferenceHierarchy();
        }
        ...
        public void onResume() {
            ...
            if (mLockScreenQs != null) {
                mLockScreenQuickSettingsPreferenceController.updateState(mLockScreenQs);
            }
        ...
        private void createPreferenceHierarchy() {
            ...
            // Lockscreen Qs
            mLockScreenQs = (RestrictedSwitchPreference) findPreference(KEY_LOCK_SCREEN_QS);
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            } else if (KEY_LOCK_SCREEN_QS.equals(key) && mLockScreenQs != null) {
                mLockScreenQuickSettingsPreferenceController.onPreferenceChange(preference, value);
            }
            return true;
        }
    }
