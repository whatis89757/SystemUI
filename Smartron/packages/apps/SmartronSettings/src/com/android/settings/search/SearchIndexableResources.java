...
import com.android.settings.gestures.SmartronGestureSettings;
...
import com.android.settings.customize.StatusBarSettings;
import com.android.settings.customize.NavigationKeysSettings;
import com.android.settings.customize.LedSettings;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        addIndex(SmartronGestureSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_gestures);
        ...
        addIndex(CustomizeSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_customize);
        addIndex(StatusBarSettings.class, R.xml.status_bar_settings, R.drawable.ic_settings_customize);
        addIndex(LedSettings.class, R.xml.led_settings, R.drawable.ic_settings_display);
        addIndex(NavigationKeysSettings.class, R.xml.navigation_keys_settings, R.drawable.ic_settings_customize);
