...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    private void updateWifiThetherSummary(Context context) {
        ...
        if (mWifiConfig == null) {
            final String s = context.getString(
                    com.android.internal.R.string.wifi_tether_configure_ssid_default);
            mCreateNetwork.setSummary(String.format(context.getString(CONFIG_SUBTEXT),
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                updateWifiThetherSummary(context);
    ...
    public void onClick(DialogInterface dialogInterface, int button) {
        if (button == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (mWifiConfig != null) {
                ...
                android.provider.Settings.Secure.putInt(getActivity().getContentResolver(), WIFI_AP_USER_SET, 1);
                int index = WifiApDialog.getSecurityTypeIndex(mWifiConfig);
