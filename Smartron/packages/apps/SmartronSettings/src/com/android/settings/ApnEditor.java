...
public class ApnEditor extends SettingsPreferenceFragment
    ...
    private void fillUi() {
        ...
        mApnType.setSummary((mApnType.getText() == null || mApnType.getText().length() == 0 ) ? "default": mApnType.getText());
    ...
    private boolean validateAndSave(boolean force) {
        ...
        callUpdate = setStringValueAndCheckIfDiff(values,
                Telephony.Carriers.TYPE,
                checkNotSet((mApnType.getText() == null || mApnType.getText().length() == 0 ) ? "default": mApnType.getText()),
                callUpdate,
                TYPE_INDEX);
