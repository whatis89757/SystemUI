...
public class RingtonePicker extends ListActivity
    ...
    class TrackListAdapter extends SimpleCursorAdapter
        ...
        public void changeCursor(Cursor cursor) {
            ...
            if (DBG) Log.v(TAG, "Setting cursor to: " + cursor
                    + " from: " + RingtonePicker.this.mCursor);

            RingtonePicker.this.mCursor = cursor;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAudioManager = (AudioManager) RingtonePicker.this.getSystemService(Context.AUDIO_SERVICE);
        ...
        mAdapter = new TrackListAdapter(this, listView,
                R.layout.ringtone_picker_item, new String[] {},
                new int[] {});
    ...
    private final BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_MEDIA_SCANNER_STARTED.equals(action) ||
                ...
                //MusicUtils.setSpinnerState(RingtonePicker.this);
            }
            doQuery(false, null);
        }
    };
...
//                Toast.makeText(RingtonePicker.this, R.string.no_permission_for_drm,
...
//        }
        ...
        if (newId != mPlayingId || mMediaPlayer == null) {
            ...
            try {
                ...
                Log.w("RingtonePicker", "Unable to play track", e);
            } catch (NullPointerException e) {
                Log.w("RingtonePicker", "The mSelectedUri is invalid", e);
            }
        ...
        switch (v.getId()) {
            case R.id.okayButton:
                if (mSelectedId >= 0) {
                    ...
                    intent.putExtra("trackId", mSelectedId);
                    setResult(RESULT_OK, intent);
                    finish();
                } else {
                    Toast.makeText(this, "Select track to set as ringtone!",
