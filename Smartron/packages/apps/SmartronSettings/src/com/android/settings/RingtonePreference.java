...
public class RingtonePreference extends Preference {
    ...
    public static final String RINGTONE_PREF = "ringtone_preference";
    ...
    private int mPhoneId = 0; /* Sub-1 by default */
    ...
    public void onPrepareRingtonePickerIntent(Intent ringtonePickerIntent) {
        ...
        if (mShowDefault) {
            if (getRingtoneType() == RingtoneManager.TYPE_RINGTONE) {
                ringtonePickerIntent.putExtra(RingtoneManager.EXTRA_RINGTONE_DEFAULT_URI,
                    RingtoneManager.getActualRingtoneUriByPhoneId(getContext(), getPhoneId()));
            } else {
                ringtonePickerIntent.putExtra(RingtoneManager.EXTRA_RINGTONE_DEFAULT_URI,
        ...
        ringtonePickerIntent.putExtra(PHONE_ID, getPhoneId());
    }
