...
public class FingerprintEnrollEnrolling extends FingerprintEnrollBase
    ...
    public void onEnrollmentError(int errMsgId, CharSequence errString) {
        ...
        switch (errMsgId) {
            case FingerprintManager.FINGERPRINT_ERROR_TIMEOUT:
                ...
                break;
            case FingerprintManager.FINGERPRINT_ERROR_REPEAT_REGION:
                showError(getString(R.string.fingerprint_repeat_region_error));
                return;
            case FingerprintManager.FINGERPRINT_ERROR_REPEAT_FINGER:
                showError(getString(R.string.fingerprint_repeat_finger_error));
    ...
    private void provideHapticFeedback() {
        if (mVibrator != null) {
            mVibrator.vibrate(new long[] { 0, 100L }, -1 /* repeat */);
        }
    }
