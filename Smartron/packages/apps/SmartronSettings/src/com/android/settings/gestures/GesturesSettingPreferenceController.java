...
public class GesturesSettingPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        if (mGestureControllers == null) {
            mGestureControllers = SmartronGestureSettings.buildPreferenceControllers(mContext,
    ...
    public void updateState(Preference preference) {
        // No need to use updateState because of using SmartronGestureSettings instead of GestureSettings
